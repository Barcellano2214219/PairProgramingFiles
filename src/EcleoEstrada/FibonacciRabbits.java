 ...
 * 
 * Create a function that determines the number of pairs of mature rabbits after
 * n months,
 * beginning with one immature pair of these idealized rabbits that produce b
 * pairs of offspring at the end of each month.
 * 
...
public class FibonacciRabbits {
    public static int fibRabbits(int n, int b) {
        int immature = 1, mature = 0, month = 0;
        while (month < n) {
            // give birth
