...
/**
 * Don't be afraid, the description is rather long but - hopefully - it is in
 * order that the process be well understood.
 * You are given a string s made up of substring s(1), s(2), ..., s(n) separated
 * by whitespaces. Example: "after be arrived two My so"
 * 
 * Task
 ...
 * strings or strings that became consecutive after a previous move. The number
 * of moves should be minimum.
 * 
 ...
 * 
 * The length of "after" is smaller than the length of "arrived". Let us move
 * them -> "be arrived after two My so"
 * 
 ...
 * length of "My" and "so" are the same, nothing to do. At the end of the
 * process, the substrings s(i) verify:
 * 
 ...
 * 
 * It is kind of roller coaster or up and down. When you have property (P), to
 * make the result more "up and down" visible t(0), t(2), ... will be lower
 * cases and the others upper cases.
 * 
 * arrange("after be arrived two My so") should return "be ARRIVED two AFTER my
 * SO"
 * 
 * Notes:
 * 
